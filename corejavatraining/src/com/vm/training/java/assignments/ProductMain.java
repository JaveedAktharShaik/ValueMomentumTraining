...
ArrayList<Product> product=new ArrayList<Product>();
          ...
          product.add(new Product(1,"Apple","fruits",23000,21));
          product.add(new Product(2,"AC","electronics",22000,23));
          product.add(new Product(3,"MAngoes","fruits",21000,20));
          product.add(new Product(4,"Tv","electronics",24000,42));
